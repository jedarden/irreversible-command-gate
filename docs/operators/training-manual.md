...
```bash
# Release binary and packs (v0.1.21, linux x86_64)
BASE=https://github.com/jedarden/irreversible-command-gate/releases/download/v0.1.21
...
# ✓ icg binary: /usr/local/bin/icg v0.1.21
